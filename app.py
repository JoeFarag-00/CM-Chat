...
app_logo = customtkinter.CTkImage(light_image=Image.open("assets/logo.png"),
                                  size=(50, 50))
...
class CMCAPP(customtkinter.CTk):
    def __init__(self):
        super().__init__()
        self.bots = None
        self.users = None
        ...
        self.tabview.add("POE") 
        self.tabview.set("POE")
        
        self.tabview.add("GPT") 
        self.tabview.set("GPT")
        
        self.tabview.add("BARD") 
        self.tabview.set("BARD")


        name_dialog = customtkinter.CTkInputDialog(text="What is your name:", title="CMC")
    ...
    def Start_Session(self):
        ...
        driver.get(f'https://chat.openai.com/')
